...
enum ArabicLearningCopy {
    ...
    private static let phraseReplacements: [(String, String)] = [
        ...
        ("الإجابة الصحيح:", "الإجابة الصحيحة:"), ("الإجابة الصحيح ", "الإجابة الصحيحة "),
        ("الإجابة الصحيح.", "الإجابة الصحيحة."), ("الإجابة الصحيح،", "الإجابة الصحيحة،"),
        ("إضغط", "اضغط"), ("إختار", "اختر"),
    ...
    static func polish(_ input: String) -> String {
        ...
        text = text.replacingOccurrences(of: " ؟", with: "؟")
        text = text.replacingOccurrences(of: " !", with: "!")
        if text.hasSuffix("الإجابة الصحيح") {
            text.removeLast("الإجابة الصحيح".count)
            text.append("الإجابة الصحيحة")
        }
