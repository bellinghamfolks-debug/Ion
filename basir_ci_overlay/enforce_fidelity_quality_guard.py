...
r14 = overlay / "apply_r14_selected_pages_and_legal.py"
...
if not r14.is_file():
    raise SystemExit("R14 selected-page/legal overlay is missing")
...
subprocess.run([sys.executable, str(r14), str(root)], check=True)
print("BASIR_QUALITY_GUARD=R14_SELECTED_PAGE_EXACT_ACCOUNTING_SECTION_AWARE_LEGAL")
