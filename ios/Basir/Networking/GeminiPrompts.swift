...
enum GeminiPrompts {
    ...
    static func documentPageInstruction(langName: String,
        ...
        p += "- ACADEMIC TRANSCRIPTS — read with row integrity and self-validation:\n"
        ...
        p += "  • The grade column uses the Saudi 5-point letter scale: "
        p += "أ+ = 5.00, أ = 4.75, ب+ = 4.50, ب = 4.00, ج+ = 3.50, ج = 3.00, "
        p += "د+ = 2.50, د = 2.00, هـ = 1.00.\n"
        p += "  • A course's earned points = its credit hours × the grade value. VERIFY every "
        p += "row against this. If a row's grade, hours, and points do NOT agree, you misread "
        p += "something — re-read that row carefully and correct it so grade, hours, and points "
        p += "are consistent (e.g. 2 hours with 9.50 points means the grade is أ, not ج+; "
        p += "3 hours with 12.00 points means ب, not أ+).\n"
        p += "  • Order the terms CHRONOLOGICALLY: earliest Hijri year first, and within a "
        p += "year الفصل الأول before الفصل الثاني before الفصل الصيفي/الثالث.\n"
