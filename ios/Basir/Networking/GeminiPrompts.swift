...
enum GeminiPrompts {
    ...
    static func documentPageInstruction(langName: String,
        ...
        p += "- If this is an academic transcript, the grade column uses Arabic letter grades "
        p += "(أ+، أ، ب+، ب، ج+، ج، د+، د، هـ). Read each grade glyph very carefully and copy it "
        p += "EXACTLY as printed; do not confuse similar letters (أ vs ب, ج vs ح, د vs ذ).\n"
